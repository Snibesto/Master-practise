export default function Input(props) {
  ...
  return (
    <div className="text-left relative mb-1.5">
      ...
      />
      <p className={`ml-2.5 ${styleMap[props.status]} ${props.status == "neutral" ? "invisible" : "visible"}`}>{props.statusMsg ? props.statusMsg : "\u00A0"}</p>
    </div>
  );
}
